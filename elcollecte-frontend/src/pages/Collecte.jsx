...
const Collecte = () => {
  ...
  const fetchCollectes = async () => {
    ...
    setError(null);
    try {
      const { data } = await client.get('/collectes?page=0&size=20');
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '360px 1fr', gap: 20, alignItems: 'start' }} className="collecte-grid">
        ...
        <div className="card animate-fade-up delay-100" style={{ padding: 24 }}>
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            ...
            <div style={{ border: '2px dashed var(--c-border)', borderRadius: 10, padding: '20px', textAlign: 'center', color: 'var(--c-ink-3)', fontSize: '0.82rem', cursor: 'pointer' }}>
