package com.elcollecte.projet.config;
        ...
        return new OncePerRequestFilter() {
            ...
            protected void doFilterInternal(HttpServletRequest request,
                ...
                if (userId != null && role != null && !role.isBlank()) {
                    ...
                    // Permissions dynamiques issues du profil (voir service-utilisateur) :
                    // conservées ici en plus du rôle legacy pour ne rien casser tant que
                    // ce service compare encore la String de rôle brute.
